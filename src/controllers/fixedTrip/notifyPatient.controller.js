...
async function notifyPacient(tripId, patientNumber, patientName, destination) {
    try {
        ...
        return {
            status: 200,
            message: "FIXED_TRANSPORT_NOTIFICATION_FAILED",
            error: error.message
        }
    }
}
